...
```{r fig.asp = 0.65, fig.width = 12, fig.align = 'center'}
mutLandscape(mutNum.table,mutGenes.table)
```

```{r fig.asp = 1, fig.width = 8, fig.align = 'center'}
coMutation(mutGenes.table)
```

```{r fig.asp = 0.7, fig.width = 10, fig.align = 'center'}
freq.table <- freqMutation(savi.table, knownDriverGene,mutGenes.table,5)
```

```{r fig.asp = 0.35, fig.width = 15, fig.align = 'center'}
...
```{r fig.asp = 0.7, fig.width = 12, fig.align = 'center'}
